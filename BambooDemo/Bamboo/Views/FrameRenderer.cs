...
// This code was taken from the CameraFrames sample in the Windows-universal-samples repo on Github
...
namespace SDKTemplate
{
    ...
    class FrameRenderer
    {
        ...
        public bool renderFramesInUI = false;
                ...
                if (inputBitmap != null)
                {
                    ...
                    else
                    {
                        ...
                        catch (ArgumentException exception)
                        {
                            ...
                            Logger.GetInstance().LogLine(exception.Message, LogLevel.Error);
                        }
